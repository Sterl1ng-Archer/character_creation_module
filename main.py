...
def attack(char_name: str, char_class: str) -> str:
    """Возвращает строку с описанием урона, нанесенного персонажем."""
...
def defence(char_name: str, char_class: str) -> str:
    """Возвращает строку с описанием блокирования урона."""
    if char_class == 'warrior':
...
def special(char_name: str, char_class: str) -> str:
    """Возвращает строку с описанием применения специального умения."""
    if char_class == 'warrior':
        return (
